...
class calculadoraParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [7]:
                localctx = calculadoraParser.AtomExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx

                self.state = 3
                localctx.value = self.match(calculadoraParser.NUM)
                pass
            elif token in [5]:
                localctx = calculadoraParser.ParenExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 4
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = calculadoraParser.OpExprContext(self, calculadoraParser.ExprContext(self, _parentctx, _parentState))
